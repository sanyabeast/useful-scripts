    ...
    function setup_gui() {
        let main_button = state.main_button = parse_html(`
           <div
               ...
               style="
                   visibility: hidden; border-radius: 50%; background: rgba(0,0,0,0.5); width: 32px; height: 32px; position: fixed; right: 24px; top: 24px; display: flex; align-items: center; justify-content: center; z-index: 99; cursor: pointer;"
               >
        ...
        let main_window = state.main_window = parse_html(`
           <div
               class="rq-main-button"
               style="visibility: visible; border-radius: 8px; background: rgba(0,0,0,0.75); width: 150px; height: 150px; position: fixed; right: 24px; top: 24px; display: flex; justify-content: flex-start; align-items: flex-start; z-index: 99; padding: 8px; font-family: monospace; flex-direction: column;"
           >
               <input class="filter" type="text" value="quotes" style="width: 100%"/>
               <p class="summary-val"            style="white-space: nowrap; ont-family: monospace; color: #eee;">0</p>
               <p class="per-second-val-1"       style="white-space: nowrap; font-family: monospace; color: #eee;">0</p>
               <p class="per-second-val-5"      style="white-space: nowrap; font-family: monospace; color: #eee;">0</p>
               <p class="per-second-val-15"      style="white-space: nowrap; font-family: monospace; color: #eee;">0</p>
               <p class="per-second-val-60"      style="white-space: nowrap; font-family: monospace; color: #eee;">0</p>

               <p class="max-per-second-val-1"   style="white-space: nowrap; font-family: monospace; color: #aaa;">0</p>
           </div>
        `);

        main_button.onclick = show_window
        main_window.querySelector('.filter').addEventListener('input', () => {
            reset();
        })
